(function () {
    ...
    angular.module('TIMECAPSULE').factory('Resource', Resource);
     ...
     Resource.$inject = ['$http','Global','Util','ErrorHandler','QueryFactory','DBpediaFactory', 'PlantsFactory'];

     function Resource($http, Global, Util, ErrorHandler, QueryFactory, DBpediaFactory, PlantsFactory)
    {
        ...
        {   
             ...
             sparql += 'SELECT DISTINCT  ?name ?conceptName ?drugName ?drugVariant ?plantName ?plantVariant ?lineNumber ?barcode ?id   ?locationName ?latitude ?longtitude ?referenceSourceName ?referenceSourceDate ?referenceSourceLanguage ';
             sparql += 'WHERE { ';
