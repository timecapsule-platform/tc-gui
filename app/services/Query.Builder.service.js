(function () {
    ...
    angular.module('TIMECAPSULE').factory('QueryBuilder', QueryBuilder);

     QueryBuilder.$inject = ['$http','Global','ErrorHandler'];

     function QueryBuilder($http, Global, ErrorHandler)
    {
