(function () {
    ...
    angular.module('TIMECAPSULE').factory('QueryBuilderCount', QueryBuilderCount);

     QueryBuilderCount.$inject = ['$http','Global','ErrorHandler'];

     function QueryBuilderCount($http, Global, ErrorHandler)
    {
        ...
        function GenerateQueryCode()
        {
            ...
            if(this.options.criteria)
                this.query.code += this.options.criteria.code;
            if(this.options.select)
                this.query.code += this.options.select.code;
        ...
        function getFilter(filterName)
        {
            ...
            {
                if(factory.options.filters[i].name == filterName)
                    return i;
            }
        ...
        function GenerateSparql(offset,limit)
        {
            ...
            this.query.networkPlant = null;
             ...
             // The graphs in FROM
            var fromGraphs = "";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/brahms> ";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/snippendaal> ";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/thesaurus> ";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/economicBotany> ";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/radar> ";
            fromGraphs += " FROM <http://timecapsule.science.uu.nl/TimeCapsule.owl/chrono> ";
            ...
            if(this.query.code === "01")
            {
                 ...
                 this.query.sparql += 'SELECT  ?nameVariant  ?lineNumber ?barcode ?id ?language ?sourceName ?sourceLanguage ?sourceDate ?sourceLocation ?slatitude ?slongitude ?nameYear ';
                 ...
                 {  
                       ...
                       { 
                           this.query.sparql += '?concept ' + Global.ns + 'name "' + this.options.from.data.plantName + '"^^xsd:string.';
                       }
                       else
                       if(this.options.from.data.drugName)
                       { 
                           this.query.sparql += '?concept ' + Global.ns + 'name "' + this.options.from.data.drugName + '"^^xsd:string.';
                       }
                     
                 }
                 this.query.sparql += '?nv ' + Global.ns + 'nameVariant ?nameVariant. ';
                 this.query.sparql += 'OPTIONAL { ?nv ' + Global.ns + 'year ?nameYear. }. ';
                 this.query.sparql += '?reference ' + Global.ns + 'refersTo ?nv. ';
                  
                 this.query.sparql += 'OPTIONAL { ?nv ' + Global.ns + 'language ?language.  }. ';
                 this.query.sparql += 'OPTIONAL { ?reference ' + Global.ns + 'lineNumber ?lineNumber.  }. ';
                 this.query.sparql += 'OPTIONAL { ?reference ' + Global.ns + 'barcode ?barcode.  }. ';
                 this.query.sparql += 'OPTIONAL { ?reference ' + Global.ns + 'id ?id.  }. ';
                 ...
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'language ?sourceLanguage. }.';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'year ?sourceDate. }.';
                 this.query.sparql += 'OPTIONAL { ';
                    this.query.sparql += ' { ?source ' + Global.ns + 'hasLocation ?slocation. } UNION { ?source ' + Global.ns + 'refersLocation ?slocation. } ';
                 ...
                 this.query.sparql += '?source ' + Global.ns + 'refersLocation ?sPoint. ';
                 this.query.sparql += ' }. '; 
                ...
                // Language Filter
                 ...
                 if( index != -1 )
                 {
                     ...
                     this.query.sparql += ' FILTER ( ?language = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 }
                 ...
                 {
                     this.query.sparql += '?source ' + Global.ns + 'hasReference ?reference. ';
                     this.query.sparql += ' { ?source ' + Global.ns + 'hasLocation ?slocation. } ';
                     this.query.sparql += ' UNION ';
                     this.query.sparql += ' { ?source ' + Global.ns + 'refersLocation ?slocation. } ';
                     this.query.sparql += '?slocation ' + Global.ns + 'name ?sourceLocation ';
                     this.query.sparql += ' FILTER ( ?sourceLocation = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 ...
                 if( index != -1 )
                 {
                     this.query.sparql += ' ?source ' + Global.ns + 'hasReference ?reference.';
                     this.query.sparql += ' ?source ' + Global.ns + 'name ?sourceName.';
                     this.query.sparql += ' FILTER ( ?sourceName = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 ...
                 if( index != -1 )
                 {
                     ...
                     this.query.sparql += 'FILTER( ?sourceDate >  ' + this.options.filters[index].data.yearFrom+ ' ). ';
                     this.query.sparql += 'FILTER( ?sourceDate <  ' + this.options.filters[index].data.yearTo +' ). ';
            ...
            if(this.query.code === "02")
            {
                 ...
                 this.query.sparql += 'SELECT ?name ?nameVariant ?pPlant ?lineNumber ?barcode ?id ?language ?sourceName ?sourceLanguage ?sourceDate ?sourceLocation ?slatitude ?slongitude ?use ?familyName ?ppart ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 ...
                 */
                 ...
                 if( index != -1 )
                 {
                     ...
                     this.query.sparql += ' ?reference ' + Global.ns + 'referredToBeProducedBy ?plantReference.';
                     this.query.sparql += ' ?plantReference ' + Global.ns + 'refersTo ?plantNv.';
                     this.query.sparql += ' ?plantNv ' + Global.ns + 'nameVariant ?plantNameVariant.';
                     this.query.sparql += ' FILTER ( ?plantNameVariant = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 }
                 ...
                 if( index != -1 )
                 {
                     this.query.sparql += ' ?reference ' + Global.ns + 'referredToBeProducedBy ?plantReference.';
                     this.query.sparql += ' ?plantReference ' + Global.ns + 'refersTo ?plantNameVariant.';
                     this.query.sparql += ' ?plantSpecies ' + Global.ns + 'hasNameVariant ?plantNameVariant.';
                     this.query.sparql += ' ?plantSpecies ' + Global.ns + 'hasFamily ?plantFamily.';
                     this.query.sparql += ' ?plantFamily ' + Global.ns + 'name ?familyName. ';
                     this.query.sparql += ' FILTER ( ?familyName = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 }
                 ...
                 {
                     this.query.sparql += '?reference ' + Global.ns + 'refersLocation ?location. ';
                     this.query.sparql += '?localtion ' + Global.ns + 'name ?locationName. ';
                     this.query.sparql += ' FILTER ( ?locationName = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 ...
                 if( index != -1 )
                 {
                     ...
                     this.query.sparql += '?reference ' + Global.ns + 'isMadeFrom ?part. ';
                     this.query.sparql += '?part ' + Global.ns + 'name ?ppart. ';
                     this.query.sparql += ' FILTER ( ?ppart = "'+this.options.filters[index].data.name+'"^^xsd:string). ';
                 }
            ...
            if(this.query.code === "03")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT ?sourceName ?lineNumber ?barcode ?id  ?sourceLanguage ?sourceDate ?sourceAuthor ?sourceLocation ?slatitude ?slongitude ?sourceUrl ?sourceDescription ?sourceType ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 ...
                 if(this.options.from)
                 {
                   this.query.sparql += '?nv ' + Global.ns + 'nameVariant "' + this.options.from.data.name + '"^^xsd:string.';
                   this.query.sparql += '?reference ' + Global.ns + 'refersTo ?nv. ';
                   this.query.sparql += '?source ' + Global.ns + 'hasReference ?reference. ';
                 ...
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'language ?sourceLanguage. }. ';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'year ?sourceDate. }. ';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'url ?sourceUrl. }. ';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'description ?sourceDescription. }. ';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'type ?sourceType. }. ';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'hasAuthor ?a. ?a ' + Global.ns + 'name ?sourceAuthor }. ';
            ...
            if(this.query.code === "04")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT ?plantName ?nameVariant  ?familyName ?genusName ?pDrug ?lineNumber ?barcode ?id ?language ?locationName ?latitude ?longitude ?sourceName ?sourceLanguage ?sourceDate ?use ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += ' WHERE { ';
                 ...
                 this.query.sparql += 'OPTIONAL {';
                 this.query.sparql += ' ?drugReference ' + Global.ns + 'referredToBeProducedBy ?reference.';
                 this.query.sparql += ' ?drugReference ' + Global.ns + 'refersTo ?drugNv.';
                 ...
                 if( index != -1 )
                 {
                     ...
                     this.query.sparql += ' ?drug ' + Global.ns + 'hasNameVariant ?drugNv.';
                     this.query.sparql += ' ?drug ' + Global.ns + 'name ?pDrug.';
                     this.query.sparql += ' FILTER ( ?pDrug = "'+this.options.filters[index].data.drugName+'"^^xsd:string). '; 
            ...
            if(this.query.code === "05")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT ?locationName ?type ?lineNumber ?barcode ?id  ?latitude ?longitude ?sourceName ?sourceLanguage ?sourceDate ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                ...
                //From Dataset
                 ...
                 this.query.sparql += ' ?source ' + Global.ns + 'name ?sourceName.';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'language ?sourceLanguage. }.';
                 this.query.sparql += 'OPTIONAL { ?source ' + Global.ns + 'date ?sourceDate. }.';
                 this.query.sparql += ' }. ';
             
                 this.query.sparql += 'OPTIONAL {';
                 this.query.sparql += ' ?reference ' + Global.ns + 'refersLocation ?point. ';
                 this.query.sparql += ' OPTIONAL{ ?reference ' + Global.ns + 'locationPropertyType ?type. }.';
                 this.query.sparql += ' ?point ' + Global.ns + 'latitude ?latitude.';
                 this.query.sparql += ' ?point ' + Global.ns + 'longitude ?longitude.';
                 this.query.sparql += ' }. ';
          
                 this.query.sparql += 'OPTIONAL {';
                 this.query.sparql += ' ?reference ' + Global.ns + 'refersSpecimen ?sp. ';
            ...
            if(this.query.code === "11")
            {
                 ...
                 this.query.sparql += 'SELECT  ?nameVariant ?pPlant ?pDrug ?lineNumber ?barcode ?id ?language ?use ?locationName ?locationType ?latitude ?longitude ?sourceName ?sourceLanguage ?sourceDate ?sourceLocation  ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 //this.query.sparql += '?nv a ' + Global.ns + 'NameVariant. ';
                 this.query.sparql += '?concept ' + Global.ns + 'hasNameVariant ?nv. ';
                 ...
                 this.query.sparql += 'OPTIONAL { ?reference ' + Global.ns + 'refersUse ?u. ?u ' + Global.ns + 'description ?use  }. ';
                 ...
                 if( index != -1 )
                 {
                     this.query.sparql += '?source ' + Global.ns + 'hasLocation ?location. ';
                     this.query.sparql += '?location ' + Global.ns + 'name "'+this.options.filters[index].data.name+'"^^xsd:string.';
                 }
            ...
            if(this.query.code === "31")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT COUNT(DISTINCT ?reference) AS ?variantCount  ?nameVariant ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 //this.query.sparql += '?nv a ' + Global.ns + 'NameVariant. ';
                 this.query.sparql += '?concept ' + Global.ns + 'hasNameVariant ?nv. ';
            ...
            if(this.query.code === "41")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT ?nameVariant ?ambiguous1 ?ambiguous2 ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 //this.query.sparql += '?nv a ' + Global.ns + 'NameVariant. ';
            ...
            if(this.query.code === "13")
            {
                 ...
                 this.query.sparql += 'SELECT DISTINCT ?sourceName ?lineNumber ?barcode ?id  ?sourceLanguage ?sourceDate ?sourceAuthor ?sourceLocation ?sourceUrl ?sourceDescription ?sourceType ';
                 this.query.sparql += fromGraphs;
                 this.query.sparql += 'WHERE { ';
                 this.query.sparql += '?source a ' + Global.ns + 'ReferenceSource. ';
