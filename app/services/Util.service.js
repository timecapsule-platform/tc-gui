        ...
        for (var i = 0; i < array.length; i++) {
          if (array[i].name.value == reference.name.value) {
            if (
              ...
              array[i].lineNumber &&
              array[i].lineNumber.value == reference.lineNumber.value
            ) {
              if (
                reference.drugVariant &&
                array[i].drugVariant &&
                reference.drugVariant != array[i].drugVariant
              ) {
                return false;
              }
              ...
              reference.barcode &&
              array[i].barcode &&
              array[i].barcode.value == reference.barcode.value
            ) {
              return true;
            } else if (
              reference.id &&
              array[i].id &&
              array[i].id.value == reference.id.value
            ) {
              return true;
            }
          }
