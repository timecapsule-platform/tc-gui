  ...
  function Query(
      ...
      for (var i = 0; i < factory.resultsTotal.length; i++) {
        ...
        if (factory.resultsTotal[i].type) {
          if (factory.resultsTotal[i].type.value == "Grows")
            ...
            factory.resultsTotal[i].type.value == "ArchaeologicalFinding"
          )
            markerIcon = "assets/images/marker-arcaeological.svg";
          else if (factory.resultsTotal[i].type.value == "Cargo")
            markerIcon = "assets/images/marker-cargo.svg";
        }

        if (
          factory.resultsTotal[i].latitude &&
          factory.resultsTotal[i].longitude
        ) {
    ...
    function GenerateSourceMarkers() {
      ...
      for (var i = 0; i < factory.resultsTotal.length; i++) {
        ...
        if (
          factory.resultsTotal[i].slatitude &&
          factory.resultsTotal[i].slongitude
        ) {
    ...
    function AddVisualizations() {
      ...
      function getFilter(filterName) {
        for (var i = 0; i < qb.options.filters.length; i++) {
          if (qb.options.filters[i].name == filterName) return i;
        }
      ...
      if (criteria == 0) {
        ...
        } else if (select && select == 3) {
        } else if (select && select == 4) {
          factory.visualizations.push("map");
        } else if (select && select == 5) {
          factory.visualizations.push("map");
        }
      }
    }
    ...
    function FixCondensed() {
      ...
      // DRUGS
      else if (factory.select && factory.select.code == 2) {
      ...
      // SOURCES
      else if (factory.select && factory.select.code == 3) {
      ...
      // PLANTS
      else if (factory.select && factory.select.code == 4) {
      ...
      // LOCATIONS
      else if (factory.select && factory.select.code == 5) {
        ...
        for (var i = 0; i < factory.locations.length; i++) {
          ...
          for (var j = 0; j < factory.references.length; j++) {
            if (
              factory.references[j].locationName &&
              factory.references[j].locationName.value == item.name
            ) {
              item.references.push(factory.references[j]);
            }
