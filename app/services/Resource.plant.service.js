(function () {
  ...
  function ResourcePlant(
    ...
    function getReferences(concept) {
      ...
      sparql +=
        "SELECT DISTINCT  ?name   ?lineNumber ?barcode ?id  ?drugName ?drugVariant ?locationName ?latitude ?longtitude ?sourceName  ?specimen ?spLatitude ?spLongtitude ";
      sparql += "WHERE { ";
      sparql += "?p  a ex:Plant. ";
      sparql += "?p " + Global.ns + 'name "' + concept + '"^^xsd:string. ';
      sparql += "?p " + Global.ns + "hasNameVariant ?nv. ";
      ...
      sparql +=
        " ?specimenLocation " + Global.ns + "longtitude ?spLongtitude. ";
      sparql += " }. ";
      sparql += " }. ";
