(function(){
	...
	angular.module("TIMECAPSULE").controller('mineralsController', mineralsController);

	// Inject services to the Controller
	mineralsController.$inject = ["$scope","$state","Auth","Navigation","Util","MessageService", "ErrorHandler","PopupService"];
	
	
	
	// Controller Logic
	function mineralsController($scope,$state,Auth,Navigation,Util,MessageService, ProductsFactory, ErrorHandler, PopupService)
	{ 
         // Urls for the View
