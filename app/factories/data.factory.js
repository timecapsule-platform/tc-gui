(function () {
  ...
  function DataFactory($http, Global) {
    ...
    function GetPublicationLocations(searchText) {
      return $http
        .get(api + "/data/source-locations" + "?search=" + searchText)
    ...
    function GetFamilies(searchText) {
      return $http
        .get(api + "/data/families" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetPlantParts(searchText) {
      return $http
        .get(api + "/data/plant-parts" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetSources(searchText) {
      return $http
        .get(api + "/data/sources" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetDepartures(searchText) {
      return $http
        .get(api + "/data/departures" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetArrivals(searchText) {
      return $http
        .get(api + "/data/arrivals" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetShips(searchText) {
      return $http
        .get(api + "/data/ships" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetCargo(searchText) {
      return $http
        .get(api + "/cargo" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
    ...
    function GetLocations(searchText) {
      return $http
        .get(api + "/locations" + "?search=" + searchText)
        .then(handleSuccess, handleError);
    }
