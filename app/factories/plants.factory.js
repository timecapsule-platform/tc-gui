...
function PlantsFactory($http,Global)
{
    ...
    {   
        return $http.get('assets/data/snipendal-images.json').then(handleSuccess, handleError);
    }
    ...
    {   
        return $http.get( api + '/plants/variants/'+variant).then(handleSuccess, handleError);
    }
    ...
    {   
        return $http.get( api + '/plants'+'?search='+searchText).then(handleSuccess, handleError);
    }
    ...
    function GetRaw()
    {   
        return $http.get('assets/data/ecob-plants-raw.json').then(handleSuccess, handleError);
    }
    ...
    {
        return $http.post(api + '/plants', plant).then(handleSuccess, handleError);
    }
    ...
    {
        return $http.put(api + '/plants/'+plant.id, plant).then(handleSuccess, handleError);
    }
    ...
    function Delete(id) 
    {   
        return $http.delete(api + '/plants/' + id).then(handleSuccess, handleError);
    }
