(function () {
  ...
  angular
    .module("TIMECAPSULE")
    .directive("progressBarSmall", progressBarSmallDirective);
    ...
    function updateProgress() {
      ...
      if ($scope.maxVal) {
        progress =
          ...
          element[0].querySelector(".progress-bar-small").clientWidth;
      }

      element[0].querySelector(".progress-bar-bar-small").style.width =
        progress + "px";
    }
