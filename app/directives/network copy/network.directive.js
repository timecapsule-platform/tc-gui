(function () {
  ...
  function networkLink($scope, element, attrs) {
    ...
    var nodes = new vis.DataSet([
      {
        id: 1,
        label: "Drug Component",
        image: "assets/images/menu-drugs-active.svg",
        shape: "image",
      },
      {
        id: 2,
        label: "Plant Species 1",
        image: "assets/images/menu-plants-active.svg",
        shape: "image",
      },
      {
        id: 3,
        label: "Plant Species 2",
        image: "assets/images/menu-plants-active.svg",
        shape: "image",
      },
      {
        id: 4,
        label: "Plant Species 3",
        image: "assets/images/menu-plants-active.svg",
        shape: "image",
      },
    ]);
